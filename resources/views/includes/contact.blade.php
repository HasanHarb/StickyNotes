...
<section id="CONTACT">
    <div class="bg-leggoo">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                    <p class="cont-text">لوريم إيبسوم هو ببساطة نص شكلي (بمعنى أن الغاية هي الشكل وليس المحتوى) ويُستخدم
                        في
                        صناعات المطابع ودور النشر.</p>
                    <address>
                        <p class=""><i class="fa fa-map-marker"></i> 124 شارع مدينه الدوله</p>
                        <p class=""><i class="fa fa-phone"></i> +1-222-111-2222 </p>
                        <p class=""><i class="fa fa-envelope"></i> yourmail@domain.com</p>
                        <p class=""><i class="fa fa-skype"></i> Your Skype Name</p>
                ...
                <div class="col-xs-12 col-sm-6 col-md-7 col-md-offset-1 col-lg-7 col-lg-offset-1">
                    <div class="contact-form">
                        <form>
                            ...
                            <div class="form-group">
                                <textarea rows="6" placeholder="الرساله..." class="form-control" name="ةثسسشلث"
                                    required></textarea>
                            </div>
                            <div class="form-group">
